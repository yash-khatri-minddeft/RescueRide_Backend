...
const sendPassMail = async (password, email, token) => {
  var mailOptions = {
    ...
    <div className="OTP-template" style="background-color: #fff; padding: 30px; ">
      ...
      <h5 style="font-weight:700"><a href="https://rescueride.onrender.com/change-ctrl-pasword?token=${token}">Click here</a></h5>
      <p>If you didn't request this, you can ignore this email. <br />Thanks, <br/>Regards.</p>
    </div>`
  };
  transporter.sendMail(mailOptions, (err, res) => {
...
const sendBookingMail = async (email, id) => {
  var mailOptions = {
    ...
    <div style="background-color: #fff; padding: 30px; ">
      ...
      <h5 style="font-weight:700"><a href="https://rescueride.onrender.com/booking-details/${id}">Click here</a></h5>
